...
$().ready(function() {
  ...
  $("#pima_error_types_col").load("<?php echo base_url("charts/pima_errors/error_types_col/$user_group_id/$user_filter_used"); ?>");
  $("#pima_error_trend").load("<?php echo base_url("charts/pima_errors/error_yearly_trends/$user_group_id/$user_filter_used"); ?>"); 
});
