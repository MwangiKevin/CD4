...
class charts_model extends MY_Model{
	public function yearly_device_test_trends($year){
		...
		$tests_details_sql 	= 	$preset_sql["tests_details"];
		$user_group_id 		=	$this->session -> userdata("user_group_id");


		$user_join_delimiter	 	=	$this->get_user_sql_join_delimiter("tests_details","`cd4_test`.`id`");
		$user_where_delimiter	 	=	$this->get_user_sql_where_delimiter();
...
/* Location: ./application/modules/poc/models/charts_model.php */