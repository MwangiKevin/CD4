...
class equipment extends MY_Controller {
	...
	public function equipment_table($user_group_id,$user_filter_used){
		$this->load->model('equipment_model');
	...
	public function equipment_tests_pie($user_group_id,$user_filter_used){
		$this->load->model('equipment_model');
	...
	public function equipment_tests_table($user_group_id,$user_filter_used){
		$this->load->model('equipment_model');
