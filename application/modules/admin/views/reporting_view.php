<div>
	...
	<form method="post" action="<?php echo base_url();?>admin/reports/submit" id="form-report">
		<div>		
							...
							<div class="mycontainer" id="full" >
								...
								<div class="input-group" style="width: 100%;padding:4px;">
									...
									<select required class="textfield form-control" id="criteria" name="criteria">
										...
										<option value="4">By District</option>
										<option value="5">By Region</option>                  					
									</select>
								</div>
								...
								<div class="input-group" style="width: 100%;padding:4px;" id="facilitydiv">
									...
									<select name='facility' id='facility' style="border-radius:0px 5px 5px 0px;"  class="textfield form-control">
										...
										<option value='<?php echo $facility["facility_id"].'.'.$device["facility_name"]; ?>'><?php echo $facility["facility_name"]; ?></option>
										<?php } ?>
									</select>
									<span id='locationInfo'></span>
								</div>
								...
								<!-- districts -->
								<div class="input-group" style="width: 100%;padding:4px;" id="districtsdiv">
									...
									<select name='district' id='district' style="border-radius:0px 5px 5px 0px;"  class="textfield form-control">
										...
										<option value='<?php echo $districts["district_id"].'.'.$districts["district_name"]; ?>'><?php echo $districts["district_name"]; ?></option>
										<?php } ?>
									</select>
									<span id='locationInfo'></span>
								</div>
								<!-- Regions -->
								<div class="input-group" style="width: 100%;padding:4px;" id="regionsdiv">
									<span class="input-group-addon" style="width: 40%;">Regions :</span>
							...
							<td>
								<div class="mycontainer" id="full">
									<div class="input-group" style="width: 100%;padding:4px;">
										...
										<span class="input-group-addon" style="width: 30%;"><img src="<?php echo img_url();?>pdf.png" width="25" height="25">&nbsp;&nbsp;&nbsp;<input type="radio" name="format" value="pdf">PDF</span>
