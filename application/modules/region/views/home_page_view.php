<div class="row">
	<div class="tabbable span12">
		<ul class="nav nav-tabs">
			<li id ="tabSummary" class="active"><a href="#tabs1-summary" data-toggle="tab">Summary</a></li>
			<li id ="tabPima"><a href="#tabs1-pima" data-toggle="tab">PIMA</a></li>
		</ul>
							...
							<center>
								...
								<table class="data-table" style=" margin-left:0px;">
				                    <tbody>
				                    	...
				                    	?>
						                <tr>
						                    <td style="background-color:#CCCCCC " nowrap="nowrap"><b></b><center><b><?php echo $device['title']?></b></center></td>
						                    <td><center><?php echo $device['totals']?></center></td>
						                    <td><center><?php echo $device['fails']?></center></td>
						                    <td><center><?php echo $device['perc_fails']?></center></td>
						...
						<td style="height:130px;width:30%;vertical-align: top;">
							<center>
								...
								<script type="text/javascript">
								    FusionCharts.setCurrentRenderer('javascript');
								    var myChart = new FusionCharts( "FusionCharts/Doughnut2D.swf", "chart1","400", "220", "0", "0");
								    myChart.setJSONUrl(" <?php echo base_url()?>partner/charts/periodic_test_perc");
			...
			<div class="tab-pane active" id="tabs1-pima">					
				<table>
					<tr>
						...
						<td style="height:130px;width:30%;vertical-align: top;">
							<center>
								<div class="section-title" ><center>Reporting Rates for the year <?php //echo $year?></center></div>
