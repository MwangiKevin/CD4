...
if(!window.__doNotPutInCookie)
{
	...
	document.cookie = "fwxtmenu="+ contentPagePath;
}

if(!window.__doNotPutInCookie && isLocalStorageAvailable() )
{
	localStorage.removeItem("fwxt__menu");
	localStorage.setItem("fwxt__menu", contentPagePath);
}	

//if(!highlightSearch) highlightSearch=function() {};
